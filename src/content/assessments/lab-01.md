...
weight: 8.33
brief:
  Placeholder — the one-sentence prompt for Lab 1 has not been
  written yet.
submissionItems:
  - Placeholder — the exact deliverable for Lab 1 has not been
    decided yet.
marking:
  mode: holistic
  description:
    Placeholder marking note — Lab 1's marking criteria have not been
    finalised yet.
keyDates:
  - label: Submission due
    date: 2027-02-26T17:00:00+10:00
spec:
...
page to link its Lab 1 bead to.
