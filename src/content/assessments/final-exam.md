...
description:
  A two-hour, in-person written examination covering the full malware
  production lifecycle, analysis, detection and operational security.
week: 12
# No exam date is stated in the source; ANU's exam period runs after
# teaching (Week 12: 26 Oct), so this is fixed to courseMeta.endDate
# (D24) rather than left implied.
due: 2027-11-12T13:00:00+10:00
weight: 40
brief: >
  A two-hour, in-person written examination covering the malware
  production lifecycle from idea to operational use, plus analysis,
  detection and operational security.
submissionItems:
  - Attendance for the full two hours, with only permitted materials
keyDates:
  - label: Examination
    date: 2027-11-12T13:00:00+10:00
marking:
  mode: holistic
  description:
